  ...
  return (
    <section className="py-20 bg-white">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-[290px_1fr] gap-10 items-center">
          <div>
        ...
        <div className="mt-[115px] grid grid-cols-1 md:grid-cols-4 gap-10">
          {stats.map((stat) => (
            <div
              key={stat.id}
            ...
            >
              <AnimatedParagraph
                ...
                charDelay={8}
              />
              <p className="text-[20px] font-normal leading-[1.5] text-[#2A2A2A]">
                {stat.label}
              </p>
            </div>
          ))}
